...
class UndermatchDoubles {
    ...
    * @param integer $player_id_1A - id for one player to reg in league
    * @param integer $player_id_1B - id for one player to reg in league
    * @param integer $score_1 - score for player1 in league
    * @param integer $player_id_2A - id for second player  in league
    * @param integer $player_id_2B - id for second player  in league
    ...
    */
    public static function createLeagueUnderMatch($connection, $undermatch_number, $match_id, $league_id, $league_group, $player_id_1A, $player_id_1B, $score_1, $player_id_2A, $player_id_2B, $score_2, $choosed_game, $table_number, $match_waiting, $match_started, $match_finished, $match_visibility, $undermatch_type) {

                    
        // sql scheme
        $sql = "INSERT INTO under_match_teams_doubles (undermatch_number, match_id, league_id, league_group, player_id_1A, player_id_1B, score_1, player_id_2A, player_id_2B, score_2, choosed_game, table_number, match_waiting, match_started, match_finished, match_visibility, undermatch_type)
        VALUES (:undermatch_number, :match_id, :league_id, :league_group, :player_id_1A, :player_id_1B, :score_1, :player_id_2A, :player_id_2B, :score_2, :choosed_game, :table_number, :match_waiting, :match_started, :match_finished, :match_visibility, :undermatch_type)";
